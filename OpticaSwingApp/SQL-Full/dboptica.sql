...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-07-2021 a las 09:06:51
...
--
-- Base de datos: `dboptica`
--
CREATE DATABASE IF NOT EXISTS `dboptica` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dboptica`;
...
INSERT INTO `lente` (`codigo`, `precio`, `color_cristal`, `color_marco`, `material_marco`, `genero`, `modelo`, `imagen`, `marca_id`) VALUES
('CC-1234', 55000, 'Amarillo', 'Negro', 'Plastico', 'Hombre', 'BB-5321', 'OBS.png', 1),
('XX-6734', 55000, 'Rojo', 'Blanco', 'Metal', 'Hombre', 'TT-7799', 'JavaScript.png', 2);
...
INSERT INTO `marca` (`id`, `nombre`, `pais_origen`, `logo`) VALUES
(1, 'Python', 'Chile', 'Python.png'),
(2, 'PHP', 'Argentina', 'PHP.png');
